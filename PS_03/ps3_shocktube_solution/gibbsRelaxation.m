...
if Yv>epsilon_bar && Yv<1-epsilon_bar
    ...
    [deltag,meang,~,~] = updateGibbsEnergies(rho,e,Yv);
...
if deltag<0 % Evaporation takes place
    ...
    p_max = updatePressure(rho,Yv_max,e);
    [deltag_max,meang,~,~] = updateGibbsEnergies(rho,e,Yv_max);
...
elseif deltag>0 % Condensation takes place
    ...
    p_min = updatePressure(rho,Yv_min,e);
    [deltag_min,meang,~,~] = updateGibbsEnergies(rho,e,Yv_min);
